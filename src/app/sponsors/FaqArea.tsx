...
const FaqArea = () => {
  ...
  useEffect(() => {
    const filtered = sponsor_faq_data.data.filter(
      (item) => item.page === "inner_faq",
    );
          ...
          <div className="col-lg-8">
            <div className="td-faq-wrapper mr-40 ml-40">
              <div
                ...
                data-wow-delay="0.3s"
              >
                <h2 className="td-faq-title mb-20">{sponsor_faq_data.title}</h2>
                <p className="td-faq-para mb-20">
                  {sponsor_faq_data.sub_title}
                </p>
              </div>

                  ...
                  <div className="row align-items-center">
                     <div className="col-xxl-9 col-xl-9 col-6">
                        <div className="tdmenu__wrap d-flex align-items-center justify-content-between">
                           ...
                           <nav className="tdmenu__nav tdmenu-3 ml-50 mr-40 d-none d-xl-flex">
                     ...
                     <div className="col-xxl-3 col-xl-3 col-6">
                        <div className="td-menu-right-action td-menu-right-action-3 d-flex align-items-center justify-content-end">
                           <div className="td-header-menu-bar lh-1 p-relative ml-20">
                              <Link className="td-btn td-left-right d-none d-xl-block" href="/contact">
                                 <span className="mr10 td-text d-inline-block mr-5">Register interest</span>

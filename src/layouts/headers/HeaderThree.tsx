...
import logo_2 from "@/assets/img/logo/vukafrik-white-gold-logo.png"
   ...
   return (
      <header className="td-header-height">
         <div className="td-header__area z-index-999 td-transparent ">
            <HeaderTopOne />
            <div id="header-sticky" className={`header-mobile-spacing ${sticky ? "header-sticky" : ""}`}>
               <div className="container-fluid container-1680">
                  <div className="row align-items-center">
                     <div className="col-xxl-9 col-xl-9 col-6">
                        <div className="tdmenu__wrap tdmenu__wrap--vukafrik d-flex align-items-center justify-content-between">
                           <div className="logo">
                           ...
                           <nav className="tdmenu__nav tdmenu__nav--vukafrik tdmenu-3 d-none d-xl-flex">
                     ...
                     <div className="col-xxl-3 col-xl-3 col-6">
                        <div className="td-menu-right-action td-menu-right-action-3 td-menu-right-action--vukafrik d-flex align-items-center justify-content-end">
                           <div className="td-header-menu-bar lh-1 p-relative ml-20">
                              <Link className="td-btn td-left-right d-none d-xl-block" href={vukafrikEvent.ctaLink}>
                              ...
                              <button onClick={() => setSidebar(true)} className="tdmenu-offcanvas-open-btn mobile-nav-toggler d-block d-xl-none" aria-label="Ouvrir le menu">
                                 <span></span>
                                 <span></span>
                                 <span></span>
                              </button>

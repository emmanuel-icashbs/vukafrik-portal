...
import Cta from "@/components/homes/home-six/Cta"
...
const FooterFive = () => {
   ...
   return (
      <footer>
         <div className="td-footer-area td-footer-2-spacing p-relative bg-position" style={{ backgroundImage: `url(${bg_img.src})` }}>
            <Cta />

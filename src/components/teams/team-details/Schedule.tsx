            ...
            <div className="row">
               <div className="col-12">
                  <div className="td-schedule-team td-team-details-schedule grey-bg">
                     <h3 className="td-schedule-team-title mb-15">Event Schedules</h3>
                     <span className="td-schedule-team-border mb-25"></span>
                     <div className="td-schedule-team-info-wrap td-border">
                        <div className="row align-items-center pb-15">
                           <div className="col-lg-7">
                              <div className="td-schedule-team-thumb mb-20">
                                 <div className="td-team-details-schedule-date">
                                    <div>
                                       <h5>16</h5>
                                       <span>jan 2025</span>
                                    </div>
                                 ...
                                 <div className="td-schedule-team-name">
                                    <span className="dates">12:00 pm - 12:00 pm</span>
                                    <h4 className="td-title"><Link href="#">Reinventing Experiences</Link></h4>
                           ...
                           <div className="col-lg-5">
                              <div className="td-schedule-team-btn">
                                 <Link className="td-btn td-left-right mb-20" href="/events-details">
                     ...
                     <div className="td-schedule-team-info-wrap td-border">
                        <div className="row align-items-center pt-35 pb-15">
                           <div className="col-lg-7">
                              <div className="td-schedule-team-thumb mb-20">
                                 <div className="td-team-details-schedule-date">
                                    <div>
                                 ...
                                 <div className="td-schedule-team-name">
                                    <span className="dates">12:00 pm - 12:00 pm</span>
                                    <h4 className="td-title"><a href="#">Reinventing Experiences</a></h4>
                                    <span className="position">Marketing Manager</span>
                                 </div>
                              </div>
                           </div>

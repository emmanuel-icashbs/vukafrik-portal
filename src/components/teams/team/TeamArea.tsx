...
const TeamArea = () => {
  ...
  return (
    <div className="td-team-area pt-130 pb-115 p-relative fix">
      <div className="container">
        <div className="row justify-content-center">
          <div className="col-lg-9">
            <div className="td-team-4-title-wrap text-center mb-45">
        ...
        <div className="row">
          {team_data.map((item) => (
            ...
            >
              <div
                className="td-team-item mb-25 bg-position p-relative"

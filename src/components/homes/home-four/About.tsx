      ...
      <div className="container">
        <div className="row align-items-center">
          <div className="col-xl-6 col-lg-10">
            <div
              className="td-about-4-content mb-15 wow fadeInLeft"
            ...
            >
              ...
              <h2 className="td-section-title mb-15">
                Educating for the Future Join 500 others Kainty <br />
                NY for a full day
              </h2>
              <p className="td-section-4-para mb-30">
                when an unknown printer took a galley of type and scrambled
                makespecimen booksurvived not only five centurie
              </p>
                  ...
                  <div className="col-lg-6 col-md-6 col-sm-6">
                    <div className="items mb-30 d-flex align-items-center">
                      <span className="mb-10 icon mr-25">
                        ...
                        >
                          <path
                            d="M23.04 31.3472V36.96C23.04 38.6368 21.68 40 20 40C18.32 40 16.96 38.6368 16.96 36.96V31.3472L20 26.0832L23.04 31.3472Z"
                            fill="currentColor"
                          />
                          <path
                            d="M23.04 3.04V8.6528L20 13.9168L16.96 8.6528V3.04C16.96 1.3632 18.32 0 20 0C20.8384 0 21.6 0.3392 22.1504 0.8896C22.7008 1.44 23.04 2.2016 23.04 3.04Z"
                            fill="currentColor"
                          />
                          <path
                            d="M16.96 8.6528V14.7328L11.6896 11.6896L8.8864 6.8352C8.048 5.3792 8.544 3.52 10 2.6784C10.48 2.4032 11.0016 2.272 11.5168 2.272C12.5696 2.272 13.5904 2.816 14.1536 3.792L16.96 8.6528Z"
                            fill="currentColor"
                          />
                          <path
                            d="M30 37.3216C28.544 38.16 26.6848 37.6608 25.8464 36.208L23.04 31.3472V25.2672L28.3104 28.3104L31.1136 33.1648C31.952 34.6208 31.456 36.48 30 37.3216Z"
                            fill="currentColor"
                          />
                          <path
                            d="M14.7328 16.96H8.6528L3.792 14.1536C2.3392 13.3152 1.84 11.456 2.6784 10C3.2416 9.024 4.2656 8.48 5.3152 8.48C5.8336 8.48 6.3552 8.6112 6.8352 8.8864L11.6896 11.6896L14.7328 16.96Z"
                            fill="currentColor"
                          />
                          <path
                            d="M37.3216 30C36.48 31.456 34.6208 31.952 33.1648 31.1136L28.3104 28.3104L25.2672 23.04H31.3472L36.208 25.8464C37.6608 26.6848 38.16 28.544 37.3216 30Z"
                            fill="currentColor"
                          />
                          <path
                            d="M13.9168 20L8.6528 23.04H3.04C1.3632 23.04 0 21.68 0 20C0 19.1616 0.3392 18.4 0.8896 17.8496C1.44 17.2992 2.2016 16.96 3.04 16.96H8.6528L13.9168 20Z"
                            fill="currentColor"
                          />
                          <path
                            d="M40 20C40 21.68 38.6368 23.04 36.96 23.04H31.3472L26.0832 20L31.3472 16.96H36.96C38.6368 16.96 40 18.32 40 20Z"
                            fill="currentColor"
                          />
                          <path
                            d="M14.7328 23.04L11.6896 28.3104L6.8352 31.1136C5.3792 31.952 3.52 31.456 2.6784 30C2.4032 29.52 2.272 28.9984 2.272 28.4832C2.272 27.4304 2.816 26.4096 3.792 25.8464L8.6528 23.04H14.7328Z"
                            fill="currentColor"
                          />
                          <path
                            d="M36.208 14.1536L31.3472 16.96H25.2672L28.3104 11.6896L33.1648 8.8864C34.6208 8.048 36.48 8.544 37.3216 10C38.16 11.456 37.6608 13.3152 36.208 14.1536Z"
                            fill="currentColor"
                          />
                          <path
                            d="M16.96 25.2672V31.3472L14.1536 36.208C13.3152 37.6608 11.456 38.16 10 37.3216C9.024 36.7584 8.48 35.7344 8.48 34.6848C8.48 34.1664 8.6112 33.6448 8.8864 33.1648L11.6896 28.3104L16.96 25.2672Z"
                            fill="currentColor"
                          />
                          <path
                            d="M31.1136 6.8352L28.3104 11.6896L23.04 14.7328V8.6528L25.8464 3.792C26.6848 2.3392 28.544 1.84 30 2.6784C31.456 3.52 31.952 5.3792 31.1136 6.8352Z"
                            fill="currentColor"
                          />
                        </svg>
                      </span>
              ...
              <div className="td-about-3-btn mt-10 d-flex align-items-center">
                <Link
                  className="td-btn td-btn-3-squre mb-15 td-left-right text3 mr-25"
                  href="/about"
                >
                ...
                <div className="td-about-3-number mb-15 d-flex align-items-center">
                  ...
                  <div>
                    ...
                    <h5 className="td-number">
                      <Link href="tel:+1(1234)-567-800">+1 (1234)-567-800</Link>
                    </h5>
                  </div>
                </div>
              </div>
          ...
          <div className="col-xl-6 col-lg-10">
            <div
              className="td-about-5-thumb mb-30 p-relative wow fadeInRight"
              data-wow-duration="1.5s"
              data-wow-delay="0.3s"
            >
                  ...
                  <div className="td-about-5-rounded-icon">
                    ...
                    >
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                        d="M38.8137 19.4068C28.0962 19.4068 19.4068 10.7174 19.4068 -0.000122919C19.4068 10.7174 10.7192 19.4068 -5.957e-05 19.4068C10.7175 19.4068 19.4068 28.0944 19.4068 38.8137C19.4068 28.0961 28.0945 19.4068 38.8137 19.4068Z"
                        fill="#F5A623"
                      />
                    </svg>
                  </div>

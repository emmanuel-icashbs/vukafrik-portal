...
const Blog = () => {
   return (
      <div className="td-blog-area pt-140 pb-110">
         <div className="container">
            <div className="row justify-content-center">
               <div className="col-xl-6 col-lg-8">
                  <div className="td-blog-title-wrap text-center mb-40 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".2s">
                     <span className="td-section-subtitle mb-25">Blog Post</span>

            ...
            <div className="row align-items-center">
               <div className="col-xl-6 col-lg-8">
                  <div className="td-hero-content p-relative mb-30 pl-165">
                     <span className="td-hero-subtitle mb-10 wow td-animetion-left" data-wow-duration="1.5s" data-wow-delay="0.1s">18 - 22 Nov, 2025</span>
                     <h2 className="td-hero-title wow td-animetion-left" data-wow-duration="1.5s" data-wow-delay="0.3s">Business  Summit 2025</h2>
                     <p className="td-hero-location wow mb-35 td-animetion-left" data-wow-duration="1.5s" data-wow-delay="0.5s">23rd Avenue, 4th Street, Chicago, Illinois, USA</p>
                     ...
                     <Link className="td-btn td-left-right wow  td-animetion-top" data-wow-duration="1.5s" data-wow-delay="0.9s" href="/about">
                        <span className="mr10 td-text d-inline-block mr-5">DISCOVER MORE</span>

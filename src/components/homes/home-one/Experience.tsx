...
const Experience = () => {
  ...
  return (
    <div
      className="td-banner-area td-banner-spacing bg-position jarallax vuka-conversion-banner"
      style={{ backgroundImage: `url(${vukafrikCta.background.src})` }}
    >
      <div className="container">
        <div className="row justify-content-center">
          <div className="col-xl-9 col-lg-11">
            <div className="td-banner-title-wrap text-center">
              <span

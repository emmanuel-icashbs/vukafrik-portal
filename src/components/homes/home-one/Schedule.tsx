...
const tab_title: string[] = ["Day 01 - jan 10, 2025", "Day 02 - jan 11, 2025", "Day 03 - jan 12, 2025", "Day 04 - jan 13, 2025"]
                                             ...
                                             <div className="row">
                                                ...
                                                <div className="col-lg-3 col-md-6 col-sm-6">
                                                   <div className="td-schedule-content text-center mb-20">
                                                      <Link className="td-btn td-left-right" href="/events-details">

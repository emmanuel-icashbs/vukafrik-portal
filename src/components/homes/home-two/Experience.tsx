...
const Experience = () => {
  ...
  return (
    <>
      <div
        className="td-banner-area td-banner-spacing-2 bg-position jarallax"
        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-xl-6 col-lg-8">
              <div
                className="td-banner-title-wrap td-banner-title-wrap-2 wow fadeInLeft"
              ...
              >
                ...
                <h2 className="td-section-title mb-15">
                  the best experience in Design Principles
                </h2>
                <p className="mb-35">
                ...
                <Link className="td-btn-square" href="/events">
                  Buy Tickets Now
                </Link>
              </div>
            </div>

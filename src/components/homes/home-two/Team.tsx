...
const Team = () => {
  return (
    <div
      className="td-team-area bg-position pt-140 pb-135"
      ...
      <div className="container">
        <div className="row align-items-center mb-20">
          <div className="col-lg-6">
            <div
              className="td-brands-title-wrap mb-25 wow fadeInLeft"
              data-wow-duration="1.5s"
              data-wow-delay="0.3s"
            >
              <span className="td-section-subtitle td-section-subtitle-2 mb-30 mb-20">
                Learn From Spekaers
              </span>
              <h2 className="td-section-title">
                Our Amazing & learned <br />
                event Speakrs
              </h2>
            </div>
          </div>
          <div className="col-lg-6">
            <div
              className="td-team-2-title-text mb-35 wow fadeInRight"
              data-wow-duration="1.5s"
              data-wow-delay="0.3s"
            >
              <p>
            ...
            >
              <div className="td-team-2-iteam p-relative mb-30">
                ...
                <div className="td-team-2-content ml-30">
                  ...
                  <span className="td-team-2-position">{item.title}</span>
                </div>

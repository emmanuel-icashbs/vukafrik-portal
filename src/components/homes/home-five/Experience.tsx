            ...
            <div className="row">
               <div className="col-xl-6 col-lg-9">
                  <div className="td-banner-title-wrap td-banner-5-wrap td-banner-6-wrap">
                     ...
                     <h2 className="td-section-title mb-20  wow fadeInLeft" data-wow-duration=".9s" data-wow-delay=".4s">the best experience<br />
                        in Fashion Trend</h2>
                     ...
                     <Link className="td-btn td-btn-3-squre mb-15 td-left-right text3 mr-25 wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.6s" href="/events-details">
               ...
               <div className="col-xl-6 col-lg-12">
                  <div className="td-banner-6-thumb wow td-animetion-right" data-wow-duration="1.5s" data-wow-delay="0.3s">

...
const Pricing = () => {
   return (
      <div className="td-pricing-area td-pricing-5-area green-bg pt-140 pb-80">
         <div className="container">
            <div className="row gx-30">
               <div className="col-xl-5 col-lg-8">
                  <div className="td-pricing-4-title-wrap td-pricing-5-title-wrap mb-40 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.3s">
                     <span className="td-section-subtitle td-section-subtitle-2 mb-30">Tickets Packages</span>
                     <h2 className="td-section-title text-white mb-10">Explore flexible<br /> pricing plans</h2>
                     <p className="td-section-text text-white">Like previous year this year we are arran<br />
                        ging world marketing summi Its the <br />
                        gathering of all the big</p>
                  </div>
               </div>
               <div className="col-xl-7 mb-30">
                  <div>
                     {price_data.filter((items) => items.page === "home_4").map((item) => (
                        <div key={item.id} className="td-pricing-4-item td-pricing-5-item mb-30">
                           <div className="row align-items-center">
                              <div className="col-lg-6 col-md-6">
                                 <div className="td-pricing-4-price mb-20">
                                    <span className="subtitle mb-25">{item.sub_title} Pass</span>
                                    <h2 className="price mb-20"><span>$</span>{item.price}.00</h2>
                                    <p className="text mb-30">{item.desc}</p>
                                    <Link className="td-btn td-btn-3-squre td-left-right text-center" href="/contact">
                              ...
                              <div className="col-lg-6 col-md-6">
                                 <div className="td-pricing-2-feature td-pricing-4-feature mb-20 ml-30">
                                    <ul>

...
const banner_slider: StaticImageData[] = [
  banner_slider1,
  banner_slider2,
  banner_slider3,
];
...
const Banner = () => {
  return (
    <div className="td-hero-area grey-bg p-relative z-index-1 fix">
      ...
      <Image
        className="td-hero-5-shape rotate-infinite-2 d-none d-xxl-block"
        src={shape_1}
        alt=""
      />
            ...
            <div className="td-hero-5-content p-relative">
              ...
              <div className="row">
                ...
                <div className="col-lg-7">
                  <div
                    className="td-hero-5-content-bottom ml-20 mb-30 wow td-animetion-right"
                    data-wow-duration="1.5s"
                    data-wow-delay="0.2s"
                  >
                    <p className="mb-20">
                      when an unknown printer took Geather galley <br />
                      type and scrambled makesp area ecimen <br />
                      survived not only five centurie
                    </p>
                    <div className="td-hero-4-border mb-30"></div>
                    <span className="td-hero-4-dates mb-10 d-inline-block">
                      17 - 25 October 2025{" "}
                    </span>
                    <p className="td-hero-4-para mb-20">
                      las Águedas, 295, 28400 Collado Villalba,
                      <br /> Burminghum, London
                    </p>
                    <Link
          ...
          <div className="col-xl-5 col-lg-9">
            <div className="td-hero-5-thumb-slider">
              <Swiper
                {...setting}
                modules={[Autoplay]}
                className="swiper-container td-hero-5-slider"
              >

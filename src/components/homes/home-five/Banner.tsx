...
import shape_1 from "@/assets/img/hero/hero-5/shape.png"
import shape_2 from "@/assets/img/hero/hero-4/zero.png"
import banner_thumb from "@/assets/img/hero/hero-5/thumb.jpg"
import banner_slider1 from "@/assets/img/hero/hero-5/thumb-2.jpg"
import banner_slider2 from "@/assets/img/hero/hero-5/thumb-3.jpg"
import banner_slider3 from "@/assets/img/hero/hero-5/thumb-4.jpg"
         ...
         <div className="container-fluid p-0">
            <div className="row">
               ...
               <div className="col-xl-5 col-lg-9">
                  <div className="td-hero-5-thumb-slider">
                     <Swiper {...setting} modules={[Autoplay]} className="swiper-container td-hero-5-slider">
                        {banner_slider.map((banner, i) => (
                           <SwiperSlide key={i} className="swiper-slide">
                              <div className="td-hero-5-thumb">

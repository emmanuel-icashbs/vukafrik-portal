...
import { vukafrikEvent, vukafrikHeroSlides } from "@/data/vukafrik-content";
                           ...
                           <div className="row align-items-end">
                              <div className="col-xl-8 col-lg-10">
                                 <div className="td-hero-3-content mb-40">
                                    ...
                                    <Link className="td-btn td-btn-3-border td-left-right text3" href={vukafrikEvent.ctaLink}>

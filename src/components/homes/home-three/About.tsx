            ...
            <div className="row align-items-center">
               <div className="col-xl-6 col-lg-9 wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.3s">
                  <div className="td-about-3-thumb mr-60 mb-30">
                     <Image className="w-100" src={about_thumb} alt="" />
                  </div>
               </div>
               <div className="col-xl-6 col-lg-9 wow fadeInRight" data-wow-duration="1.5s" data-wow-delay="0.3s">
                  <div className="td-about-3-content-wrap mb-15">
                     <div className="td-about-2-content">
                        <span className="td-section-subtitle td-section-subtitle-2 td-section-subtitle-3 mb-15">About This Meetup</span>
                        <h2 className="td-section-title mb-15">Why you should<br /> Join Our Event Program</h2>
                        ...
                        <p className="para mb-40">when an unknown printer took a galley of type and scrambled it to make
                     ...
                     <div className="td-about-3-btn d-flex align-items-center">
                        <Link className="td-btn td-btn-3-squre mb-15 td-left-right text3 mr-25" href="/events">

...
const Blog = () => {
   return (
      <div className="td-blog-area pt-140 pb-110 bg-position" style={{ backgroundImage: `url(${bg_img.src})` }}>
            ...
            <div className="row justify-content-center">
               <div className="col-xl-6 col-lg-8">
                  <div className="td-schedule-2-title-wrap text-center mb-40 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.3s">
                     <span className="td-section-subtitle td-section-subtitle-2 td-section-subtitle-3  mb-30">Blog Post</span>
            ...
            <div className="row">
               {blog_data.filter((items) => items.page === "home_1").map((item) => (
                  <div key={item.id} className="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".3s">
                     <div className="td-blog-item td-blog-6-item mb-30">

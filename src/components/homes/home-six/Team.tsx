...
const team_shapes: JSX.Element[] = [
  <>
    ...
    >
      <path
        d="M210.695 118.999C219.214 105.616 226.145 92.0142 230.94 78.7134C253.185 16.8942 221.118 -15.1865 159.287 7.05907C145.973 11.8534 132.372 18.7709 119.003 27.3047C105.634 18.7846 92.0184 11.8534 78.718 7.05907C16.887 -15.1865 -15.1928 16.8942 7.0658 78.7134C11.86 92.0279 18.7773 105.63 27.3109 118.999C18.791 132.382 11.86 145.984 7.0658 159.285C-15.1791 221.104 16.887 253.185 78.718 230.939C92.0321 226.145 105.634 219.228 119.003 210.694C132.372 219.214 145.987 226.145 159.287 230.939C221.105 253.185 253.185 221.118 230.94 159.285C226.145 145.971 219.228 132.369 210.695 118.999Z"
        fill="#FFEBF8"
      />
    </svg>
  </>,
  ...
  <>
    ...
    >
      <path
        d="M242 0L168.797 29.7886V0L95.594 29.7886V0L0 38.9039L0 163L73.203 113.348V163L146.417 113.348V163L242 98.1741L213.674 61.6851L242 0Z"
        fill="#ffebf8"
      />
    </svg>
  </>,
  <>
    ...
    >
      <path
        d="M223.956 97.124C250.479 72.3691 244.119 40.158 204.861 18.9664C157.986 -6.32215 81.9979 -6.32215 35.1391 18.9664C-4.11926 40.158 -10.4791 72.3691 16.0438 97.124C-5.34412 117.091 -5.34412 141.909 16.0438 161.876C-10.4791 186.631 -4.11926 218.842 35.1391 240.034C81.9979 265.322 157.986 265.322 204.861 240.034C244.119 218.842 250.479 186.631 223.956 161.876C245.344 141.909 245.344 117.091 223.956 97.124Z"
        fill="#ffebf8"
      />
    </svg>
  </>,
  <>
    ...
    >
      <path
        d="M238.137 237.571C126.654 204.529 112.203 204.53 0.707113 237.566C33.7534 126.08 33.7537 111.63 0.7124 0.145998C112.196 33.1873 126.647 33.187 238.132 0.140711C205.086 111.626 205.085 126.077 238.127 237.56L238.137 237.571Z"
        fill="#ffebf8"
      />
    </svg>
  </>,

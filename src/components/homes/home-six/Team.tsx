...
const team_data: DataType[] = [
   ...
   },
   {
      ...
      shape: (<><svg width="242" height="163" viewBox="0 0 242 163" fill="none" xmlns="http://www.w3.org/2000/svg">
         <path d="M242 0L168.797 29.7886V0L95.594 29.7886V0L0 38.9039L0 163L73.203 113.348V163L146.417 113.348V163L242 98.1741L213.674 61.6851L242 0Z" fill="#ffebf8" />
      </svg></>),
      thumb: team_3,
      title: "Robert Fox",
      designation: "Sr. Software Engineer",
   ...
   },
   {
      ...
      shape: (<><svg width="239" height="238" viewBox="0 0 239 238" fill="none" xmlns="http://www.w3.org/2000/svg">
         <path d="M238.137 237.571C126.654 204.529 112.203 204.53 0.707113 237.566C33.7534 126.08 33.7537 111.63 0.7124 0.145998C112.196 33.1873 126.647 33.187 238.132 0.140711C205.086 111.626 205.085 126.077 238.127 237.56L238.137 237.571Z" fill="#ffebf8" />
      </svg></>),
      thumb: team_5,
      title: "Jane Cooper",
      designation: "Sr. Software Engineer",
            ...
            <div className="row justify-content-center">
               <div className="col-lg-7 col-md-10">
                  <div className="td-team-tittle-wrap text-center mb-30">
                     ...
                     <h2 className="td-section-title mb-15 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.5s">Conference speakers</h2>
                     <p className="td-section-text wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.7s">Like previous year this year we are arranging world marketing <br />

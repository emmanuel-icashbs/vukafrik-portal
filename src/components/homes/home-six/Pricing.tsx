...
const Pricing = () => {
   return (
      <div className="td-pricing-area grey-bg pt-140 pb-110 p-relative z-index-1 fix">
            ...
            <div className="row gx-30">
               {price_data.filter((items) => items.page === "home_4").map((item) => (
                  <div key={item.id} className="col-xl-4 col-lg-6 col-md-6 mb-30">
                     <div className="td-pricing-2-item td-pricing-3-item td-pricing-6-item wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.3s">
                        <div className="td-pricing-2-price mb-10">
                           <span className="subtitle mb-15">{item.sub_title} Pass</span>
                           <span className="price mb-20 d-block">${item.price}.00</span>
                           <p>{item.desc}</p>
                        </div>

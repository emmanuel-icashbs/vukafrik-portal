         ...
         <div className="container">
            <div className="row justify-content-center">
               <div className="col-xxl-7 col-xl-9 col-lg-10">
                  ...
                  <div className="nav td-schedule-tab-btn td-schedule-3-tab-btn td-schedule-6-tab-btn justify-content-center mb-50  wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.5s" id="v-pills-tab" role="tablist" aria-orientation="vertical">
            ...
            <div className="row">
               <div className="tp-contact-form-wrapper  tab-content" id="v-pills-tabContent">
                  {event_two_data.filter((items) => items.page === "home_6").map((items, index) => (
                     <div key={items.id} className={`tab-pane fade ${activeTab === index ? 'show active' : ''}`} id="v-pills-home1" role="tabpanel" aria-labelledby="v-pills-home1-tab">
                        {items.event_details.map((item) => (
                           <div key={item.id} className="td-schedule-3-wrap td-schedule-6-wrap mb-10">
                              <div className="row align-items-center">
                                 ...
                                 <div className="col-xl-8 col-lg-7">
                                    <div className="td-schedule-3-content">
                                       <span className="td-schedule-2-date mb-15"><i className="flaticon-calendar"></i>{item.date}</span>
                                       <h2 className="td-schedule-3-title mb-20"><Link href="/events-details">{item.title}</Link></h2>

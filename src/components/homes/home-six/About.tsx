      ...
      <div className="td-about-area pt-150 pb-110">
        <div className="container">
          <div className="row align-items-center">
            <div
              className="col-xl-6 col-lg-9 wow fadeInLeft"
                ...
                <div className="td-about-7-video">
                  <div className="p-relative d-inline-block">
                    ...
                    <a
                      ...
                      className="td-video-play popup-video"
                    >
            ...
            >
              <div className="td-about-3-content-wrap mb-15">
                <div className="td-about-2-content">
                  ...
                  <div className="td-about-3-clients td-about-7-clients mb-25">
                    <div className="items mb-10 d-flex">
                      ...
                      <div>
                        ...
                        <p className="para">
                          conference a full day of inspiring keynotes
                          connections for software Product Managers.
                        </p>
                      </div>
                    </div>
                  ...
                  <Link
                    className="td-btn td-btn-green td-btn-3-squre td-left-right text3 d-inline-block"
                    href="/about"
                  >
                    <span className="mr10 td-text d-inline-block mr-5">
                      Become an Attendance
                    </span>

        ...
        <div className="row">
            ...
            <div className="coupon__code-wrap">
              <div className="coupon__code-info">
                ...
                <a
                  ...
                  style={{ color: "#192b4c", cursor: "pointer" }}
                  id="coupon-element"
                >
          ...
          <div className="col-lg-5">
            <div className="order__info-wrap">
              ...
              <ul className="list-wrap">
                ...
                {productItem.map((add_item, i) => (
                  <li key={i}>
                    {add_item.title}{" "}
                    <strong>
                      {add_item.price.toFixed(2)} x {add_item.quantity}
                    </strong>
                    <span>
                      ${(add_item.quantity * add_item.price).toFixed(2)}
                    </span>
                  </li>
                ))}
                <li>
              ...
              <button onClick={notify} className="td-btn w-100">
                Place order
              </button>
            </div>
          </div>

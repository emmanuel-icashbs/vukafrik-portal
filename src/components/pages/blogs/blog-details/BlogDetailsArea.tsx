...
import { BlogDataType } from "@/data/MeetUpData";
            ...
            <div className="td-postbox-wrapper mr-20 mb-40">
              <div className="td-postbox-item mb-40">
                <div className="td-postbox-thumb mb-25">
                  <Image
                    className="w-100"
                    src={single_blog ? single_blog.thumb : blog_1}
                    alt=""
                  />
                </div>
                <div className="td-postbox-content">
                  <div className="td-blog-date mb-10">
                    ...
                    <span className="mr-20 date">
                      ...
                      >
                        <path
                          d="M15.4638 17.4999L9.95457 13.5647L4.44531 17.4999V4.90733C4.44531 4.48986 4.61115 4.08948 4.90635 3.79429C5.20154 3.49909 5.60192 3.33325 6.01939 3.33325H13.8898C14.3072 3.33325 14.7076 3.49909 15.0028 3.79429C15.298 4.08948 15.4638 4.48986 15.4638 4.90733V17.4999Z"
                          stroke="#444444"
                          strokeWidth="1.6"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                  ...
                  <h3 className="td-blog-title mb-15">
                    {single_blog
                      ? single_blog.title
                      : "Bundle  And Save On Smashing Books Workshops"}
                  </h3>
                  <p className="mb-15">
                    em ante, dapibus in, viverra quis, feugiat a, tellus.
                    Phasellus viverra nulla ut metus varius laoreet. Quisque
                    rutrum. Aene an imperdiet. Etiam ultricies nisi vel augue.
                    Curabitur ullamcorper ultricies nisi. Nam eget dui. Etiam
                    rhoncusMaecenas tempususMaece, tellus eget condimen
                  </p>
                  <p className="mb-40">
                    Applications are like the lifeblood of mobile phones and
                    tablets today. The true potential of your areaw gear jimanwe
                    mob ile phon harnessed by applications can provide utility.
                    Apps come under various segments.Applications are like the
                    lifeb lood of moones and tablets todayue potential of your
                    mobile phone.
                  </p>
                  <h3 className="td-blog-title-sm mb-20">
                    At lacus nibh in scelerisque arcu at it pellen tesque ?
                  </h3>
                  <p className="mb-45">
                    Applications are like the lifeblood of mobile phones and
                  ...
                  <div className="td-postbox-details-qoute">
                    <blockquote className="td-postbox-blockquote">
                      <p>
                        Modern lifeblood of mobile phones and tablets today. The
                        true potential your phone tions can provide utility.
                  ...
                  <p className="mt-30 mb-40">
                    Mpplications are like the lifeblood of mobile phones and
                    tablets today. The true potential of your mobile phone is
                    harnessed by applications can provide utility. Apps come
                    under various segments.Applications are like the lifeblood
                    of mobile phones and tablets todayue potential of your
                    mobile phone.
                  </p>
                  <h3 className="td-blog-title-sm mb-10">
                    What You Need to Know about the Facebook Product Design
                    Interview and What to do about it?
                  </h3>
                  <p>
                    Facebook are like the lifeblood of mobile phones and tablets
                    today. The true potential of your mobile phone is harnessed
                    by applications can provide utility. Apps come under various
                    segments.Applications are like the lifeblood of mobile
                    phones and tablets todayue potential of your mobile phone.
                  </p>
                </div>
              </div>
              <div className="td-postbox-item mb-55 td-product-bottom-border pb-60">
                ...
                <div className="td-postbox-content">
                  <p className="mb-50">
                    Facebook are like the lifeblood of mobile phones and tablets
                    today. The true potential of your mobile phone is harnessed
                    plications can provide utility. Apps come under various
                    segments.Applications are like the lifeblood of mobile
                    phones tablets todayue potential of your mobile phone.
                  </p>
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-12">
                      <div className="td-postbox-navigation mb-40">
                        <div className="td-postbox-navigation-icon">
                          <span className="navigation-btn mb-10 d-inline-block">
                            <a href="#">
                              <i className="fa-solid fa-arrow-left-long mr-10"></i>{" "}
                              Previous post:
                            </a>{" "}
                          </span>
                          <p className="td-postbox-navigation-para m-25">
                            fter years of occasionally pissing off
                            <br /> clients with sloppy project management
                          </p>
                          <span className="td-date">
                            <i className="flaticon-calendar"></i>24, December
                          </span>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="td-postbox-navigation text-right mb-40">
                        <div className="td-postbox-navigation-icon">
                          <span className="navigation-btn mb-10 d-inline-block">
                            <a href="#">
                              Next post:{" "}
                              <i className="fa-regular fa-arrow-right-long ml-10"></i>
                            </a>
                          </span>
                          <p className="td-postbox-navigation-para m-25">
                            fter years of occasionally pissing off

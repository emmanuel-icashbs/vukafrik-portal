      ...
      <div className="container">
        <div className="row justify-content-center">
          <div className="col-xxl-7 col-xl-9 col-lg-10">
            ...
            <div
              className="nav td-schedule-tab-btn td-schedule-3-tab-btn td-schedule-6-tab-btn justify-content-center mb-50  wow fadeInUp"
              data-wow-duration="1.5s"
              data-wow-delay="0.5s"
              id="v-pills-tab"
              role="tablist"
        ...
        <div className="row">
          ...
          >
            {exhibition_data.map((items, index) => (
              <div
                key={items.id}
                    ...
                    <div className="row align-items-center">
                      ...
                      <div className="col-xl-8 col-lg-7">
                        <div className="td-schedule-3-content">
                          <span className="td-schedule-2-date mb-15">

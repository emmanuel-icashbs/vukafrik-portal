...
const EventArea = () => {
   ...
   return (
      <div className="td-schedule-area  pt-140 pb-110 bg-position" data-background="assets/img/schedule/schedule-4/bg.jpg">
         <div className="container">
            <div className="row justify-content-center">
               <div className="col-xxl-8 col-xl-9 col-lg-10">
                  <div className="td-schedule-2-title-wrap text-center mb-40 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.3s">
                     ...
                     <h2 className="td-section-title">Join the world&apos;s leading companies  at Business Conference</h2>
                  </div>
            ...
            <div className="row">
               <div className="tp-contact-form-wrapper tp-black-bg9  tab-content" id="v-pills-tabContent">
                  {event_two_data.filter((items) => items.page === "inner_event").map((items, index) => (
